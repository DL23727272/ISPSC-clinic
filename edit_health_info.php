...
$fields = [
    ...
    'lmp','menarche','duration','amount','menstrual_interval','menstrual_symptoms','menstrual_others',
    'oral_hygiene','dental_complaints','fam_cancer_form','fam_asthma_form','fam_others','fam_heart'
];
...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($conn->query($update_sql)) {
        echo "<script>Swal.fire('Success','Record updated successfully!','success').then(()=>{window.location='patients.php'});</script>";
    } else {
